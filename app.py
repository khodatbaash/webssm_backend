"""
if you're moving to a server, you might want to change the host_ip
"""
...
def readdata():
    ...
    if request.method == 'GET':
        ...
        #message = {'greeting':json.dumps(csv_dict).replace('\n', '')}
        return jsonify(csv_dict)  # serialize and use JSON headers
